	...
	<section>
		<div class="am-card" style="margin-bottom:14px;">
			<div class="am-card-body">
				<h1 style="margin:0;font-size:22px;font-weight:900;"><?php the_archive_title(); ?></h1>
				<?php if ( get_the_archive_description() ) : ?>
					<div style="margin-top:8px;color:var(--am-muted);"><?php echo wp_kses_post( get_the_archive_description() ); ?></div>
				<?php endif; ?>
			</div>
		</div>
